...
<form class="mt-4 space-y-4 sm:mt-6 sm:space-y-6" wire:submit="login">
    <div class="space-y-3">
        ...
        <a href="{{ route('auth.github.redirect') }}" type="button" class="w-full text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
            ...
            {{ __('quickpanel.login_github') }}
        </a>

    </div>
    <div class="flex items-center">
        <div class="h-px w-full bg-gray-200 dark:bg-gray-700"></div>
        <div class="px-5 text-center text-gray-500 dark:text-gray-400">{{ __('quickpanel.or') }}</div>
        <div class="h-px w-full bg-gray-200 dark:bg-gray-700"></div>
    </div>
    ...
    <div>
            <label for="captcha" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">{{ __('quickpanel.captcha') }}</label>
            <div class="grid grid-cols-12 gap-2 items-center">
                ...
                <div class="col-span-12 sm:col-span-6">
                    <input
                        type="text"
                        id="captcha"
                        class="block w-full text-sm font-medium text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('captcha') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror"
                ...
                <div class="col-span-6 sm:col-span-4">
                    <img src="{{ $captchaSrc }}" class="h-10 w-full object-contain rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800" alt="captcha" />
                </div>
                <!-- Refresh button -->
                <div class="col-span-6 sm:col-span-2 flex">
                    <button type="button" wire:click="refreshCaptcha" class="w-full inline-flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-lg dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 dark:text-white">
    ...
    <div class="flex flex-col items-center justify-center gap-2">
        ...
        >
            <span>{{ __('quickpanel.register') }}</span>
        </a>
    </div>
