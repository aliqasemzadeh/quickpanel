<x-livewire-modal::stack>
    ...
    >
        ...
        <form wire:submit.prevent="update" class="space-y-6">
            ...
            <div>
                <label class="{{ $errors->has('password') ? 'block mb-2 text-sm font-medium text-red-700 dark:text-red-500' : 'block mb-2 text-sm font-medium text-gray-900 dark:text-white' }}">{{ __('quickpanel.password') }} ({{ __('quickpanel.optional') }})</label>
