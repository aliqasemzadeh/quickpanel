@props([
    'type' => 'button',
    'color' => 'default', // options: default, alternative, dark, light, green, red, yellow, purple
    'size' => 'base',     // options: xs, sm, base, lg, xl
    'class' => '',        // extra classes from caller
])
...
$colorClasses = [
    'default' => 'text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
    'alternative' => 'text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700',
    ...
    'light' => 'text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700',
...
$classes = ($sizeClasses[$sizeKey] ?? $sizeClasses['base'])
    . ' '
...
<button type="{{ $type }}" {{ $attributes->merge(['class' => $classes . ($class ? ' ' . $class : '')]) }}>
    {{ $slot }}
</button>
