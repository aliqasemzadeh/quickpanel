...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/administrator/user-management/user/index', App\Livewire\Administrator\SettingManagement\Option\Index::class)->name('administrator.setting-management.option.index');
    Route::get('/administrator/user-management/role/index', App\Livewire\Administrator\SettingManagement\Function\Index::class)->name('administrator.setting-management.function.index');
});
