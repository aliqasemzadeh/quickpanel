...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/user-management/role/index', App\Livewire\Admin\UserManagement\Role\Index::class)->name('admin.user-management.role.index');
    Route::get('/admin/user-management/permission/index', App\Livewire\Admin\UserManagement\Permission\Index::class)->name('admin.user-management.permission.index');
});
